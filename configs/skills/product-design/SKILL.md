---
name: product-design
description: "用於分析既有專案的 UI／UX、操作流程、資訊層級、互動設計與介面改善。遵循專業產品設計標準：資訊架構、互動狀態完整性、設計系統與設計標記 (Design Tokens)、UX 啟發式評估與既有介面優化診斷。觸發情境：UI／UX 審查、操作流程梳理、介面改善建議、資訊層級診斷、元件狀態檢查。"
author: Product Design / Zypsy
version: 1.0.0
---
